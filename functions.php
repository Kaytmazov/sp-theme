...
if ( ! function_exists( 'sp_theme_setup' ) ) :
	...
	function sp_theme_setup() {
		 ...
		 * to change 'sp-theme' to the name of your theme in all the template files.
		 */
...
function sp_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'sp_theme_content_width', 1110 );
}
...
function sp_theme_scripts() {
  wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/libs/bootstrap/css/bootstrap.min.css', array(), '3.3.7' );

  wp_enqueue_style( 'sp-theme-style', get_stylesheet_uri() );

  wp_deregister_script( 'jquery' );
	wp_register_script( 'jquery', '//ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js', false, null, true );
  wp_enqueue_script( 'jquery' );

  wp_register_script( 'popper-js', '//cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js', array('jquery'), null, true );
	wp_enqueue_script( 'popper-js' );

	wp_enqueue_script( 'sp-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

  wp_enqueue_script( 'sp-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

  wp_register_script( 'bootstrap-js', get_template_directory_uri() . '/libs/bootstrap/js/bootstrap.min.js', array('popper-js'), null, true );
  wp_enqueue_script( 'bootstrap-js' );

	wp_enqueue_script( 'scripts-js', get_template_directory_uri() . '/js/scripts.min.js', array('bootstrap-js'), null, true );
}
